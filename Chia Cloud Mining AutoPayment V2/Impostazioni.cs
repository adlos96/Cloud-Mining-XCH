...
namespace Chia_Cloud_Mining_AutoPayment_V2
{
    public partial class Impostazioni : Form
    {
        ...
        private void salvaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Chia_Cloud_Mining_AutoPayment_V2.Properties.Settings.Default.Chia_Price_txt = text_Chia_Price_Path.Text + @"\Chia_value.txt";
            Chia_Cloud_Mining_AutoPayment_V2.Properties.Settings.Default.Pyton_exe = text_Python_Path.Text;
            Chia_Cloud_Mining_AutoPayment_V2.Properties.Settings.Default.Chia_Price_api = text_Chia_API_Path.Text + @"\prezzo_chia.py";
            Chia_Cloud_Mining_AutoPayment_V2.Properties.Settings.Default.Cmd = text_Cmd_Payment_Path.Text + @"\Pagamento.cmd";
