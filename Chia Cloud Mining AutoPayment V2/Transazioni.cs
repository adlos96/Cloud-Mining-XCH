    ...
    public partial class Transazioni : Form
    {
        ...
        private void Transazioni_Load(object sender, EventArgs e)
        {
            ...
            {   //Assegna ad una "stringa" nodo il valore del file .xml
                ...
                string[] nuovariga = {idContatto, nodeNome_Utente.InnerText, nodeWallet.InnerText, nodeTransaction_id.InnerText, nodeImporto_Accreditato_euro.InnerText,
                    nodeImporto_Accreditato_Xch.InnerText, nodeCredito.InnerText, nodeRimanente.InnerText, nodePrezzo_Chia.InnerText, nodeRendimento.InnerText, nodeData_Time.InnerText};
